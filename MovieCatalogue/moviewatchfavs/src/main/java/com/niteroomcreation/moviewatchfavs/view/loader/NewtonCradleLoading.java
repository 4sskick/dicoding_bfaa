package com.niteroomcreation.moviewatchfavs.view.loader;
...
public class NewtonCradleLoading extends LinearLayout {
    ...
    private void initAnim() {
        rotateRightAnimation = new RotateAnimation(0, -DEGREE, RotateAnimation.RELATIVE_TO_SELF,
                PIVOT_X, RotateAnimation.RELATIVE_TO_SELF, PIVOT_Y);
        ...
        rotateLeftAnimation = new RotateAnimation(0, DEGREE, RotateAnimation.RELATIVE_TO_SELF,
                PIVOT_X, RotateAnimation.RELATIVE_TO_SELF, PIVOT_Y);
